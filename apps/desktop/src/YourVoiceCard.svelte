  ...
  <div class="av-card flex flex-col">
    <div class="flex gap-4 p-3.5">
      ...
      <div class="flex min-w-0 flex-1 flex-col gap-2">
        ...
        <div class="flex items-center gap-3"><span class="av-kicker w-11">Match</span><div class="relative h-1.5 flex-1 bg-white/[0.08]"></div><span class="font-mono text-[10px] text-zinc-500">Not measured</span></div>
      </div>
    </div>
    <div class="flex flex-wrap items-center gap-2 border-t border-white/[0.06] px-3.5 py-2.5">
      ...
      <span class="flex-1"></span><button type="button" class="av-btn av-btn-ghost av-btn-sm" aria-expanded={phrasesOpen} onclick={() => phrasesOpen = !phrasesOpen}>What it's built from</button>
    </div>
    {#if phrasesOpen}
