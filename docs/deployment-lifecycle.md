...
support. Package creation requires schema13 through19 to match the actual frozen
...
Current source writes schema19. Schema17 adds the monotonically increasing native
...
must match planner-v4 and normal-speech-v3; older wire versions reject.
