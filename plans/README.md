...
| M1 | Establish workspace, contracts, build/static gates, and configuration (no tests per owner override) | M0 | PARTIAL — Windows Static and bundled-asset release Build independently passed at docs-only `56089d5` (source `8bc7b23`); Spark ARM64 Static independently passed at `834965f`, with executor release confirmed in its log; remaining contracts/telemetry incomplete |
