...
| M1 | Establish workspace, contracts, build/static gates, and configuration (no tests per owner override) | M0 | PARTIAL — Windows Static independently passed at `89e4894` (source `3654f46`) and Spark ARM64 Static at `89e4894`; Windows bundled-asset release Build independently passed at `95a84b1`; executor ARM release at `89e4894` confirmed in its log; remaining contracts/telemetry incomplete |
