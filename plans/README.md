...
| M1 | Establish workspace, contracts, build/static gates, and configuration (no tests per owner override) | M0 | PARTIAL — latest Windows Static independently passed at `1f550be`; latest full bundled-asset release Build passed at source `1bfd6bb`; shared core/server passed independent Spark ARM64 Static at `1f550be`, with executor ARM release confirmed in its log; remaining contracts/telemetry incomplete |
