...
| M1 | Establish workspace, contracts, build/static gates, and configuration (no tests per owner override) | M0 | PARTIAL — latest Windows Static independently passed at `09bc208`; latest full bundled-asset release Build passed at `2063be6`; shared core/server passed independent Spark ARM64 Static at `09bc208`, with executor ARM release confirmed in its log; remaining contracts/telemetry incomplete |
