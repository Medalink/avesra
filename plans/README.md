...
| M1 | Establish workspace, contracts, build/static gates, and configuration (no tests per owner override) | M0 | PARTIAL — latest Windows Static and full bundled-asset release Build independently passed at source `ee35025`; shared core/server passed independent Spark ARM64 Static at `42939a2`, with executor ARM release confirmed in its log; remaining contracts/telemetry incomplete |
...
| M5 | Control Chrome/Brave and desktop/CLI prompt inputs | M4 | IN PROGRESS — typed local pairing transport, native-host/extension persistence and Settings confirmation UI through `ee35025` reviewed against the approved design source and passed full Windows Static/release Build; these paths remain uninvoked and rendered parity unverified; selected-installation lifetime, origin grants and document ownership specified for subsequent implementation; page operations and native prompt drivers remain unavailable |
