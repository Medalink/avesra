...
| M1 | Establish workspace, contracts, build/static gates, and configuration (no tests per owner override) | M0 | PARTIAL — Windows Static, full Windows bundled-asset release Build and Spark ARM64 Static independently passed at docs-only `1ecbbff` (source `37f3113`), with executor ARM release confirmed in its log; remaining contracts/telemetry incomplete |
...
| M4 | Ship overlay, settings, onboarding, and volume/app launch slice | M3 | PARTIAL — approved design port, native settings/tray/local controls inspected; source includes native volume adapter through `95a84b1`, immutable app catalog/executable launch through `3fb18ae`, and bounded shortcut/App Paths discovery through `37f3113`; generated-voice management and design-matched Settings through `11580d0`, plus native shortcuts/editor through `6b21ac9`, pass Static/release Build; native effects, discovery, shortcuts, setup and new UI remain uninvoked; focus/package support, owner setup/onboarding and usable action ingress incomplete |
