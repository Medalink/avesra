...
| M1 | Establish workspace, contracts, build/static gates, and configuration (no tests per owner override) | M0 | PARTIAL — latest Windows Static independently passed at source `67d4afb`; latest full bundled-asset release Build passed at `4d68443`; shared core/server passed independent Spark ARM64 Static at `67d4afb`, with executor ARM release confirmed in its log; remaining contracts/telemetry incomplete |
