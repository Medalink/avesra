...
| M1 | Establish workspace, contracts, build/static gates, and configuration (no tests per owner override) | M0 | PARTIAL — Windows and Spark ARM64 Static independently passed at `e65ac87`; Windows bundled-asset release Build independently passed at `95a84b1`; executor ARM release at `e65ac87` confirmed in its log; remaining contracts/telemetry incomplete |
