...
| M1 | Establish workspace, contracts, build/static gates, and configuration (no tests per owner override) | M0 | PARTIAL — latest Windows Static independently passed at source `d2083c0`; latest full bundled-asset release Build passed at `a1a7286`; shared core/server passed independent Spark ARM64 Static at `d2083c0`, with executor ARM release confirmed in its log; remaining contracts/telemetry incomplete |
