...
| M1 | Establish workspace, contracts, build/static gates, and configuration (no tests per owner override) | M0 | PARTIAL — latest Windows Static and full bundled-asset release Build independently passed at `32c241e`; matching shared core/server passed independent Spark ARM64 Static at `b26cb47`, with executor ARM release confirmed in its log; remaining contracts/telemetry incomplete |
