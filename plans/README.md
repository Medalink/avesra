...
Current installed Windows UI: **7690fc1**; controller: **d024f36** (unchanged native/service source), 2026-09-26. Plan001 remains
...
| [003](003-voice-avatar.md) | Draw each enrolled person's voice as a reproducible avatar matching the authoritative mock | P2 | M, staged | Plan 001 protected owner and enrollment flow | IN PROGRESS — PR14 (5b43c37) adds protected native parameters and the mock-aligned People card. Static/source review passed; actual installed rendering, repeatability and full acceptance remain unproven. Optional portrait capture is unfinished and parked. |
