...
| M1 | Establish workspace, contracts, build/static gates, and configuration (no tests per owner override) | M0 | PARTIAL — latest Windows Static independently passed at source `311ee97`; latest full bundled-asset release Build passed at `1fe3367`; shared core/server passed independent Spark ARM64 Static at `311ee97`, with executor ARM release confirmed in its log; remaining contracts/telemetry incomplete |
